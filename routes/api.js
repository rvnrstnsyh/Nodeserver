...
route.post("/sign_in", [middleware.csrf, middleware.captcha.verify, validator.sign_in], controllers.api.sign_in);
route.post("/sign_up", [middleware.csrf, middleware.captcha.verify, validator.sign_up], controllers.api.sign_up);
